...
//				System.out.println();
	...
	public ArrayList<Review> getMovieReviews(String urlToTitle) throws IOException{
	...
	public Movie getMovieData(String urlToTitle) throws IOException{
		Movie m = new Movie();
	...
	public static void main(String[] args) throws IOException, InterruptedException{
		...
		Scanner sc = new Scanner(new File("LinksToCrawlIMDB.txt"));
